...
add_action('widgets_init', 'register_ending_soonest_auctions_big_widget');
function register_ending_soonest_auctions_big_widget() {
	register_widget('auctionTheme_ending_sonnest_auctions_big');
}

class auctionTheme_ending_sonnest_auctions_big extends WP_Widget {

	function auctionTheme_ending_sonnest_auctions_big() {
		$widget_ops = array( 'classname' => 'ending-soonest-auctions-big', 'description' => __('Show ending soonest auctions (big)','AuctionTheme') );
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'ending-soonest-auctions-big' );
		parent::__construct( 'ending-soonest-auctions-big', __('AuctionTheme - Ending soonest (big)','AuctionTheme'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		if(empty($limit) || !is_numeric($limit)) $limit = 5;
				 ...
				 ?>
                     ...
                     <?php auctionTheme_get_post('ending'); ?>
