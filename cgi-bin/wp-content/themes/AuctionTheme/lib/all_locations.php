...
function AuctionTheme_all_locations_area_function()
{
		...
		?>
         ...
         <div class="col-xs-12 col-sm-8 col-lg-9">
    		...
    		<div class="my_box3">
                ...
                <div class="box_title"><?php echo __("All Locations", 'AuctionTheme'); ?></div>
		...
		$contor = 0;
		 ...
		 if ( $count > 0 ){
			...
			$cnt	= 1;
			   ...
			   $total_ads = AuctionTheme_get_custom_taxonomy_count2('auction', $term->slug, 'auction_location');
