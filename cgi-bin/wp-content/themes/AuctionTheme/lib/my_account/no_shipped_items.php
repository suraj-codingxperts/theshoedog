...
function AuctionTheme_my_account_not_shipped_auctions_area_function()
{
...
<div id="content" class="account-content-area col-xs-12 col-sm-8 col-lg-9">
            ...
            <div class="my_box3">
            	...
            	<div class="box_title"><?php _e("Not Shipped Items","AuctionTheme"); ?></div>
				...
				$querystr = "
				 ...
				 ?>
                     ...
                     <?php
                      			...
                      			auctionTheme_get_post_not_shipped();
		...
		if($my_page > 1)
		echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_not_shipped_auctions_id', $previous_pg).'"><< '.__('Previous','AuctionTheme').'</a>';
		echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_not_shipped_auctions_id', $start_me).'"><<</a>';
		...
		for($i = $start; $i <= $end; $i ++) {
			if ($i == $pages_curent) {
				...
				echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_not_shipped_auctions_id', $i).'">'.$i.'</a>';
		...
		echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_not_shipped_auctions_id', $end_me).'">>></a>';
		echo '<a href="'.AuctionTheme_get_browse__special_pg_link('AuctionTheme_my_account_not_shipped_auctions_id', $next_pg).'">'.__('Next','AuctionTheme').' >></a>';
